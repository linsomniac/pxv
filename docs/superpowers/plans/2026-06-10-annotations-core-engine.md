...
- Ellipse hit-testing uses a normalized-radius band (`tol / min(rx, ry)`) — exact for circles, slightly generous along an eccentric ellipse's major axis. Accepted heuristic.
